    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          >
            <PatternBg color="rgba(255,255,255,0.95)" size="360px" maxOpacity={0.3} fadeFrom="br" offsetX="-40px" offsetY="20px" />
            <Squiggle
              color="#21263F"
              opacity={0.1}
              variant="loop"
          ...
          >
            <PatternBg color="rgba(255,255,255,0.95)" size="220px" maxOpacity={0.3} fadeFrom="tr" offsetX="20px" offsetY="-10px" />
            <div className="relative z-10">
              {[
